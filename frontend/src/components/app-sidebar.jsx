...
export function AppSidebar({ ...props }) {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: Bell,
      label: "Notifications",
      show: permissions.canAccess('notifications')
    },
    {
        ...
        <SidebarHeader className="border-b border-sidebar-border/50 px-3 py-4">
          ...
          {!isCollapsed && (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200 -mx-2 -my-1"></div>
              
              <div className="relative z-10 flex items-center gap-3 w-full">
                {!logoError ? (
                  <div className="h-12 w-12 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-200 group-hover:scale-105">
                    <img 
                      src={logocarso}
                      alt="Carso Logo" 
                  ...
                  <div className="h-12 w-12 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg group-hover:shadow-xl transition-all duration-200 group-hover:scale-105">
                    C
                  </div>
                )}
          ...
          {isCollapsed && (
            ...
            >
              {!logoError ? (
                <div className="h-10 w-10 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-200 group-hover:scale-110">
                  <img 
                    src={logocarso}
                    alt="Carso Logo" 
                ...
                <div className="h-10 w-10 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg group-hover:shadow-xl transition-all duration-200 group-hover:scale-110">
                  C
                </div>
              )}
            </div>

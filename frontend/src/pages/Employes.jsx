...
//                         </td>
//                         <td className="px-4 md:px-6 py-4">
//                           <span className="inline-flex items-center rounded-full bg-blue-100/30 text-blue-700 dark:text-blue-400 px-3 py-1 text-xs font-semibold border border-blue-200 dark:border-blue-800">
//                             Actif
//                           </span>
//                         </td>
